...
const Login = () => {
    ...
    const handleGithubClick = () => {
        // Replace 'YOUR_CLIENT_ID' with your actual GitHub OAuth client ID
        const clientID = 'Ov23ctTOgT0FhY9gJ2Cj';
    ...
    return (
        ...
        <>
            <div className='flex items-center  justify-center flex-col w-screeN h-screen bg-slate-700 '>
                <div className='text-white mb-6'>
                    <h1 className='font-bold text-4xl'>Welcome to Daan</h1>
                ...
                <div className='grid grid-cols-2 gap-28 justify-center items-center mt-10'>
                    <div className='flex items-center justify-items-center flex-col gap-5'>
                        ...
                        <button onClick={handleGithubClick}
                            ...
                            <svg class="h-6 w-12 mr-2" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink"
                    ...
                    <div>
                        ...
                        <p>Don't have an account? <Link to="/signup" className='text-blue hover:text-xl text-green-200 cursor-pointer'>Signup</Link></p>
                        </div>
                    </div>
                </div>
            </div>
